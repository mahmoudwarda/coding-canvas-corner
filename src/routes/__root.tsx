...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An interactive, mission-based coding course for kids aged 9–15." },
      { name: "author", content: "Coding Explorers" },
      { property: "og:site_name", content: "Coding Explorers" },
